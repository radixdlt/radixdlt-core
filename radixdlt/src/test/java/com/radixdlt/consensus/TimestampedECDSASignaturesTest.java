...
public class TimestampedECDSASignaturesTest extends  SerializeObject<TimestampedECDSASignatures> {
	...
	private static TimestampedECDSASignatures create() {
		...
		ImmutableMap<ECPublicKey, Pair<Long, ECDSASignature>> keyToTimestampAndSignature = ImmutableMap.of(
			k1, Pair.of(1L, new ECDSASignature()),
			k2, Pair.of(2L, new ECDSASignature())
		);
